...
//    public Iterable<Storage> sava(Iterable<Storage> entities){
//        return storageRepo.save(entities);
//    }


    public void remove(Integer pkId){
        storageRepo.delete(pkId);
    }
    ...
    //public void remove(Iterable<Storage> storages){
//        storageRepo.delete(storages);
//    }
